...
func (s *Service) broadcastRemoteActionStarted(ref *remoteActionRef) {
	s.logRemoteAction(ref, RemoteActionLogInput{
		...
		Details: session.ToJSON(RemoteActionContext{
			SiteId:     ref.SiteID,
	...
	if s.wsHub != nil {
		s.wsHub.BroadcastWithSession(
			"remote_plugin_action_started",
			RemoteActionStartedEvent{
				SiteId:     ref.SiteID,
				SiteName:   ref.Site.Name,
				Action:     ref.Action,
				PluginSlug: ref.PluginSlug,
...
func (s *Service) handleRemoteActionError(ctx context.Context, ref *remoteActionRef, appErr *apperror.AppError, durationMs int64) {
	...
	if s.sessionService != nil && ref.SessionID != "" {
		s.sessionService.LogStageEnd(session.StageEndInput{
	...
	s.broadcastRemoteActionComplete(remoteActionCompleteInput{
		Ref:       ref,
		IsSuccess: false,
		ErrMsg:    appErr.Error(),
		DurationMs: durationMs,
...
func (s *Service) saveRemoteErrorResponse(sessionId string, errDetails *ExtractedErrorDetails, appErr *apperror.AppError) {
	...
	s.sessionService.SaveError(session.SaveErrorInput{
		SessionID: sessionId,
...
func (s *Service) handleRemoteActionSuccess(ctx context.Context, ref *remoteActionRef, durationMs int64) {
	...
	s.log.Info(
		fmt.Sprintf("Remote plugin %sd", ref.Action),
		"siteId", ref.SiteID,
...
func (s *Service) broadcastRemoteActionComplete(input remoteActionCompleteInput) {
	...
	s.wsHub.BroadcastWithSession(
		"remote_plugin_action_complete",
		RemoteActionCompleteEvent{
