...
var GoEndpointMap = map[WPEndpointName]GoEndpointRoute{
	...
	EPEnablePlugin:      {Method: httpmethod.Put, Pattern: "/api/v1/sites/{id}/remote-plugins/enable"},
	EPDisablePlugin:     {Method: httpmethod.Put, Pattern: "/api/v1/sites/{id}/remote-plugins/disable"},
...
var WPEndpointMap = map[WPEndpointName]WPEndpointRoute{
	...
	EPEnablePlugin:      {Method: httpmethod.Put, Endpoint: ep.Enable},
	EPDisablePlugin:     {Method: httpmethod.Put, Endpoint: ep.Disable},
