...
//
// All factories use lazy service resolution (func() interface{}) because the global
...
// Use for endpoints that take a single URL ID param and return (interface{}, error).
func handleActionByID(
	getService func() interface{},
	serviceName string,
	paramName string,
	paramLabel string,
	errCode string,
	fn func(ctx context.Context, id int64) (interface{}, error),
) http.HandlerFunc {
...
func handleSiteActionByID(
	errCode string,
	fn func(ctx context.Context, siteID int64) (interface{}, error),
) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
...
func handleSiteActionByIDWithOpts(
	errCode string,
	fn func(ctx context.Context, siteID int64, opts map[string]interface{}) (interface{}, error),
) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if Services == nil || Services.SiteService == nil {
			respondError(w, http.StatusServiceUnavailable, "E9001", "Site service not available")
...
func handleTwoIDs(
	...
	errCode string,
	fn func(ctx context.Context, id1, id2 int64) (interface{}, error),
) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		if !requireService(w, getService(), serviceName) {
			return
...
func decodeOptionalOpts(r *http.Request) map[string]interface{} {
...
func siteService() interface{} {
	if Services == nil { return nil }
	return Services.SiteService
}
func pluginService() interface{} {
	if Services == nil { return nil }
	return Services.PluginService
}
func syncService() interface{} {
	if Services == nil { return nil }
	return Services.SyncService
}
func gitService() interface{} {
	if Services == nil { return nil }
	return Services.GitService
}
func watcherService() interface{} {
	if Services == nil { return nil }
	return Services.WatcherService
}
func publishService() interface{} {
	if Services == nil { return nil }
	return Services.PublishService
}
func backupService() interface{} {
	if Services == nil { return nil }
	return Services.BackupService
}
func versionServiceGetter() interface{} { return VersionService }
func e2eServiceGetter() interface{}     { return E2EService }
