...
func registerSiteRoutes(api *mux.Router) {
	...
	api.HandleFunc("/sites/{id}/remote-plugins/enable", handlers.EnableRemotePlugin).Methods("PUT")
	api.HandleFunc("/sites/{id}/remote-plugins/disable", handlers.DisableRemotePlugin).Methods("PUT")
	...
	api.HandleFunc("/sites/{id}/remote-logs/rotation", handlers.GetRemoteLogsRotationStatus).Methods("GET")
...
func registerPublishRoutes(api *mux.Router) {
	...
	api.HandleFunc("/plugins/{id}/sites/{siteId}/diff", handlers.ComputeDiff).Methods("GET")
