...
Per the [namespace import integrity lesson](../../.lovable/memory/architecture/php/namespace-import-integrity-lesson.md), PHP traits do not inherit `use` imports from the classes they are mixed into. Missing imports cause fatal errors that only surface after OPcache is cleared.
