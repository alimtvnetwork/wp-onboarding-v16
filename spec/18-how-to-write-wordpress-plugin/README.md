...
| 05 | [05-helpers-responses-and-integration.md](05-helpers-responses-and-integration.md) | Helpers, Response Envelope & Integration | Helper classes, `EnvelopeBuilder` fluent API, standard response format, integration checklist for new features, Split DB concept |
