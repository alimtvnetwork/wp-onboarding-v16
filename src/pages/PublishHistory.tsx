...
import { Trash2, Search, BarChart3, Clock, CheckCircle2, XCircle, AlertTriangle, ExternalLink, RefreshCw, ListFilter } from "lucide-react";
...
import { PublishAnalyticsTab } from "@/components/publish-history/PublishAnalyticsTab";
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground text-sm">
            {siteNameParam ? `Activity logs for ${siteNameParam}` : "Audit log and analytics for all publish operations"}
          </p>
        </div>
        {activeTab === "history" && (
