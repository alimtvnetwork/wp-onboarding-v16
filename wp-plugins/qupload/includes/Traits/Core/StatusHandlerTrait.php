    ...
    public function handleStatus(WP_REST_Request $request): WP_REST_Response {
        ...
        return EnvelopeBuilder::success()
            ...
            ->setSingleResult([
                ...
                ResponseKeyType::Api->value         => PluginConfigType::apiFullNamespace(),
                ...
                ResponseKeyType::DbAvailable->value => $dbAvailable,
                ResponseKeyType::ServerTime->value  => DateHelper::nowIso(),
