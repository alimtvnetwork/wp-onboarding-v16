<?php
/**
 * WorkerJobTrait — Snapshot job lifecycle management.
 *
 * Handles job creation, status updates, batch progress tracking,
 * finalization, scheduling, and progress queries.
 *
