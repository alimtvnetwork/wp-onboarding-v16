...
trait AgentLoggingTrait {
    ...
    private function insertActionRecord(\PDO $pdo, int $agentId, string $action, ?string $plugin, string $status, ?array $details, ?string $errorMsg): int {
    ...
    private function fetchAgentActions(\PDO $pdo, int $agentId, int $limit, int $offset): array {
