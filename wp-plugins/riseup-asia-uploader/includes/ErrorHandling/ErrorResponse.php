...
class ErrorResponse {
    ...
    public static function logAndReturn(FileLogger $logger, \Throwable $e, string $context = ''): array {
    ...
    public static function logAndReturnWithTrace(FileLogger $logger, \Throwable $e, string $context = '', int $skipFrames = 1): array {
    ...
    public static function logAndReturnEnvelope(FileLogger $logger, \Throwable $e, string $context = '', int $status = 500): \WP_REST_Response {
        $logger->logException($e, $context);
    ...
    public static function logAndReturnWpError(FileLogger $logger, \Throwable $e, string $context = '', string $code = 'internal_error', int $status = 500): \WP_Error {
        $logger->logException($e, $context);
    ...
    public static function logAndReturnFalse(FileLogger $logger, \Throwable $e, string $context = ''): false {
        $logger->logException($e, $context);
