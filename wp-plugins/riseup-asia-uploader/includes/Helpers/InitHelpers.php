...
class RiseupInitHelpers {
    ...
    public static function initSqliteConnection(string $dbPath, RiseupFileLogger $logger): ?PDO {
    ...
    private static function checkSqlitePrerequisites(string $dbPath, RiseupFileLogger $logger): bool {
    ...
    private static function warnPdoUnavailable(RiseupFileLogger $logger, string $message): void {
    ...
    private static function createPdoConnection(string $dbPath, RiseupFileLogger $logger): ?PDO {
        try {
