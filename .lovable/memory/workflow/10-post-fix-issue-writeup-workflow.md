...
| When a DB migration renames columns, ALL consumer code reading from those tables must be updated in the same commit. Search for old column names with grep. | `07-snake-case-db-column-references-after-v13` | `/spec/01-app/enum-consumer-checklist.md` |
