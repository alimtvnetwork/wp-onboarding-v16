...
Strict boolean logic standards apply across all languages (PHP, TS, Go). Six principles are enforced (spec: `spec/01-coding-guidelines/boolean-principles.md` v2.1.0):
